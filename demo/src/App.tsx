import { Button, Tooltip, Loading, Flex, Card, Typography, Alert, Steps, Input } from 'djuno-design'
      ...
      <Flex direction='col' className='gap-7 mx-auto min-w-[500px] my-10 '>
        <Card title='Inputs'>
          <Flex className='gap-3 w-full'>
            <Input label='input label' loading={false} loadingType='elastic' copyableFn={() => 'test text'} />
            <Button>Add</Button>
          </Flex>
        </Card>
        ...
        <Card title='Alert'>
          <Flex direction={'col'} className='gap-3 w-full'>
            ...
            <Alert showIcon type='warning' message='Djuno Design. Warning Alert' />
            <Alert showIcon type='success' message='Djuno Design. Success Alert' />
            ...
            <Alert banner showIcon type='info' message='Djuno Design. Info Alert' />
          </Flex>
        </Card>
        ...
        <Card title='Typography' description='different types of text'>
          <Typography>
            <Flex direction='col' className='gap-2'>
              ...
              <Text tooltip={{ content: "I'm a tooltip for <Typography/>" }}>Djuno Design (toottip)</Text>
        ...
        <Card title='Typography' description='copyable options'>
          <Flex direction={'col'} className='gap-3 w-full'>
            ...
            <Text copyable={{ text: 'Hello, Djuno Design!' }}>Replace copy text.</Text>
            <Text
              copyable={{
        ...
        <Card title='Button'>
          <Flex direction='col' className='gap-3'>
            <Flex items={{ default: 'center' }} className='gap-2'>
              ...
              <Button uiType='primary' loading={btnLoading} loadingType='elastic' onClick={handleClick}>
                Primary
              </Button>
            ...
            <Flex items='center' className='gap-2'>
              ...
              <Button uiType='primary' loading={btnLoading} onClick={handleClick} disabled>
                Primary
              </Button>
